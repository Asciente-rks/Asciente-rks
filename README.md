...
| **Swiftrace** | Personal Project | Solo | Frontend deployed on Vercel, Backend deployed on AWS | TypeScript | Serverless Framework, CloudFormation, S3, DynamoDB, Lambda, ReactJS, Vite, TailwindCSS | Developing a simple Logistics System in order to practice Serverless Infrastructure |
