...
* **Resiliency through Decoupling:** I utilize **Amazon SQS** and **SNS** to build event-driven, asynchronous architectures. This decoupling ensures that system components remain resilient and independent, preventing cascading failures under heavy load.
