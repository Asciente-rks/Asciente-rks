...
| **System Pulse** | Personal Project | Solo | Frontend deployed on Vercel, Backend deployed on AWS Lambda | TypeScript | Fastify, DynamoDB, Lambda, SQS, SNS, S3, ReactJS, Vite, TailwindCSS | Developed an automation tester to check if the service is up by trigerring /health endpoints of the systems |
